...
namespace rocket_engine_calc
{
    public class Drawer
    {
        ...
        private Graphics g;
        //Konstruktor
        public Drawer(Color contour_color,float contour_width, Form_Drawboard form)
        {
        ...
        public void DrawChamberContour(double d_throat, double d_chamber, double d_exit, double l_chamber, double l_nozzle)
        {
